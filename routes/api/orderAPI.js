...
router.post('/', async (req, res) => {
    ...
    try {
        await ordersDal.addOrder(req.body.firstName, req.body.lastName );
        res.statusCode = 201;
...
router.put('/:id', async (req, res) => {
    ...
    try {
        await ordersDal.putOrder(req.params.id, req.body.firstName, req.body.lastName);
        res.statusCode = 200;
...
router.patch('/:id', async (req, res) => {
    ...
    try {
        await ordersDal.patchOrder(req.params.id, req.body.firstName, req.body.lastName);
        res.statusCode = 200;
        res.json({message: "OK", status: 200});
    } catch {
        // log this error to an error log file.
